...
`,position:{start:323,end:323}}],precompiled:!0});const i=e=>e,h=(e={})=>{const n=s.twig({id:"/var/www/html/src/components/svg_item/svg_item.twig",data:[{type:"logic",token:{type:"Twig.logic.type.set",key:"textClass",expression:[{type:"Twig.expression.type.array.start",value:"[",match:["["]},{type:"Twig.expression.type.string",value:"mht-svg-item__text"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.variable",value:"dateformat",match:["dateformat"]},{type:"Twig.expression.type.string",value:"mht-svg-item__text--dateformat"},{type:"Twig.expression.type.string",value:""},{type:"Twig.expression.type.operator.binary",value:"?",precidence:16,associativity:"rightToLeft",operator:"?"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.array.end",value:"]",match:["]"]}],position:{start:0,end:111}},position:{start:0,end:111}},{type:"raw",value:`
<div class="mht-svg-item">
  <div class="mht-svg-item__icon">
    `,position:{start:112,end:179}},{type:"logic",token:{type:"Twig.logic.type.include",only:!1,ignoreMissing:!1,stack:[{type:"Twig.expression.type.string",value:"../../media/icon/icon.twig"}],withStack:[{type:"Twig.expression.type.object.start",value:"{",match:["{"]},{type:"Twig.expression.type.variable",value:"iconName",match:["iconName"]},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.variable",value:"color",match:["color"]},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"size"},{type:"Twig.expression.type.string",value:"x-small"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.object.end",value:"}",match:["}"]}],position:{start:179,end:286}},position:{start:179,end:286}},{type:"raw",value:`  </div>
  <div class="`,position:{start:287,end:310}},{type:"output",position:{start:310,end:335},stack:[{type:"Twig.expression.type.variable",value:"textClass",match:["textClass"],position:{start:310,end:335}},{type:"Twig.expression.type.filter",value:"join",match:["|join","join"],position:{start:310,end:335},params:[{type:"Twig.expression.type.parameter.start",value:"(",match:["("],position:{start:310,end:335}},{type:"Twig.expression.type.string",value:" ",position:{start:310,end:335}},{type:"Twig.expression.type.parameter.end",value:")",match:[")"],position:{start:310,end:335},expression:!1}]}]},{type:"raw",value:'">',position:{start:335,end:337}},{type:"output",position:{start:337,end:348},stack:[{type:"Twig.expression.type.variable",value:"title",match:["title"],position:{start:337,end:348}}]},{type:"raw",value:`</div>
</div>
`,position:{start:348,end:348}}],precompiled:!0});n.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),i(n.render({attributes:new r(t),active_theme:"my_super_theme",is_front_page:!1,...e}))}catch(t){return i("An error occurred whilst rendering /var/www/html/src/components/svg_item/svg_item.twig: "+t.toString())}};export{h as S};
