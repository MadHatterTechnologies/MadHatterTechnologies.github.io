...
`,position:{start:323,end:323}}],precompiled:!0});const i=n=>n,v=(n={})=>{const e=c.twig({id:"/var/www/html/src/components/cta_svg/cta_svg.twig",data:[{type:"raw",value:`<div class="container-cta-svg">
  <div class="cta-svg--icon">
    `,position:{start:0,end:66}},{type:"logic",token:{type:"Twig.logic.type.include",only:!1,ignoreMissing:!1,stack:[{type:"Twig.expression.type.string",value:"../../media/icon/icon.twig"}],withStack:[{type:"Twig.expression.type.object.start",value:"{",match:["{"]},{type:"Twig.expression.type.variable",value:"iconName",match:["iconName"]},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"color"},{type:"Twig.expression.type.string",value:"secondary"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.operator.binary",value:":",precidence:16,associativity:"rightToLeft",operator:":",key:"size"},{type:"Twig.expression.type.string",value:"responsive"},{type:"Twig.expression.type.comma"},{type:"Twig.expression.type.object.end",value:"}",match:["}"]}],position:{start:66,end:195}},position:{start:66,end:195}},{type:"raw",value:`  </div>
  <div class="cta-svg--text">
    <h3>`,position:{start:196,end:243}},{type:"output",position:{start:243,end:253},stack:[{type:"Twig.expression.type.variable",value:"text",match:["text"],position:{start:243,end:253}}]},{type:"raw",value:`</h3>
    <h4>`,position:{start:253,end:267}},{type:"output",position:{start:267,end:280},stack:[{type:"Twig.expression.type.variable",value:"subtext",match:["subtext"],position:{start:267,end:280}}]},{type:"raw",value:`</h4>
  </div>
</div>
`,position:{start:280,end:280}}],precompiled:!0});e.options.allowInlineIncludes=!0;try{let o=n.defaultAttributes?n.defaultAttributes:[];return Array.isArray(o)||(o=Object.entries(o)),i(e.render({attributes:new p(o),active_theme:"my_super_theme",is_front_page:!1,...n}))}catch(o){return i("An error occurred whilst rendering /var/www/html/src/components/cta_svg/cta_svg.twig: "+o.toString())}},k={title:"Components/CTA/CTA SVG",parameters:{componentSubtitle:"CTA SVG"},argTypes:{text:"Live chat hours",subtext:"Monday - Friday  9:00am - 4:00pm",iconName:{description:"SVG Icon Selection",table:{defaultValue:{summary:"svg-house"}},options:["house","services","mcmatch","contactus","landlord-login","landlord-login-hover","student-login","student-login-hover","search","notification","support","mobile-menu","live-chat","student-services","landlord-services","neighbourhoods","transit","cities","facebook","x","instagram","back","next","next-circle","prev-circle","next-circle-o","prev-circle-o","save","save-o","accordion-up","accordion-down","next-circle-transparent","next-circle-transparent-o","user","card","date","lock","success","fail","phone","email","company","chat","college","listing","reviews","share","connecting","note","terms","thunder","ac","bedroom","heating","swim","dishwasher","fridge","tv","fireplace","secure-house","transit","laundry","dryer","coin-laundry","microwave","internet-included","common-area","gym","stove","vacuum","sofa","dining-table","parking","visitor-parking","study-desk","private-bathroom","under-bed-storage","shared-kitchen","closet","iron"],control:{type:"select"}}},args:{text:"Live chat hours",subtext:"Monday - Friday  9:00am - 4:00pm",iconName:"live-chat"},component:v},t={};var r,l,a;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:"{}",...(a=(l=t.parameters)==null?void 0:l.docs)==null?void 0:a.source}}};const y=["CTASVGDefault"];export{t as CTASVGDefault,y as __namedExportsOrder,k as default};
