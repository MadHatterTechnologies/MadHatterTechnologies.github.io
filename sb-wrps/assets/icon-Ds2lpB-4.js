...
`,position:{start:323,end:323}}],precompiled:!0});e.options.allowInlineIncludes=!0;try{let o=n.defaultAttributes?n.defaultAttributes:[];return Array.isArray(o)||(o=Object.entries(o)),s(e.render({attributes:new l(o),active_theme:"my_super_theme",is_front_page:!1,...n}))}catch(o){return s("An error occurred whilst rendering /var/www/html/src/media/icon/icon.twig: "+o.toString())}};export{h as I};
